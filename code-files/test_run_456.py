...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 14:06:55 2024
...
os.chdir("/home/jaminkiukkonen/Desktop/work/SummerProject/code-files/")
...
def run_lib(afglms_file_name: str, wlen_min: float, wlen_max: float, 
    ...
    path_afglms = "/home/jaminkiukkonen/Desktop/work/SummerProject/mls_files/" + afglms_file_name

    libradtran_general_path = "/home/jaminkiukkonen/libRadtran-2.0.5"
    ...
    ini_files_save_loc = "/home/jaminkiukkonen/Desktop/work/SummerProject/ini_files/"

    # Saving location of libradtran output
    output_file_loc_JSON = "/home/jaminkiukkonen/Desktop/work/SummerProject/output_params/"
    ...
    for idx, conf_obj in enumerate(conf_obj_list):
        ...
        with open(ini_files_save_loc + afglms_file_name + "_conf_obj" + str(idx + 1) + ".ini", "w") as f:
            conf_obj.write(f)
    ...
    def save_output_params(results):
        ...
        df.to_json(output_file_loc_JSON + afglms_file_name + ".json", orient="columns", indent=4)
...
y = run_lib(afglms_file_name=name, 
            wlen_min=500.0008435, 
            wlen_max=799.9996703, 
            phi=0, 
            phi0=0, 
            alt=0, 
            sza=35, 
