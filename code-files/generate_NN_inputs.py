...
X.to_csv("/home/jaminkiukkonen/Desktop/tensorflow/input_data/input.csv", index=False)

#%%
###############################################################################
# To load the data back in, run this.
###############################################################################

data = pd.read_csv("/home/jaminkiukkonen/Desktop/tensorflow/input_data/input.csv")

#%%
###############################################################################
# Ensuring that the file saved correctly.
###############################################################################

print((X == data).all().all())              # True
print((X.values == data.values).all())      # True
print((X.columns == data.columns).all())    # True
